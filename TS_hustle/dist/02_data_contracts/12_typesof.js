...
console.log(describeTypeOf("Hi"), describeTypeOf(23), describeTypeOf(true), // Fixed trailing comma syntax error
describeTypeOf(10n), describeTypeOf(Symbol("Afnan")), describeTypeOf(undefined), describeTypeOf(() => { }), describeTypeOf(null), describeTypeOf({}));
