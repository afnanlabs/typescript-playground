...
async function fetchUserById(id: string): Promise<UserPayload> {
...
function delayExecution(ms: number): Promise<string> {
...
async function runParallelOperations(): Promise<void> {
